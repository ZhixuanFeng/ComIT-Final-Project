...
function repositionBorder() {
    ...
    this.graphics.drawRoundedRect(cardXPositions[this.posIndex] * this.scale.x - 3, cardYPosition * this.scale.y - 3, this.borderWidth, this.borderHeight, 10);
    this.graphics.visible = false;
}
...
function Card(aGame, aParent, aName, aAddToStage, aEnableBody, aPhysicsBodyType, positionIndex, cardInfo) {
    ...
    this.graphics = game.add.graphics();
    this.graphics.lineStyle(4, 0xFFFF00, 1);
    this.graphics.drawRoundedRect(x * this.scale.x - 3, y * this.scale.y - 3, this.borderWidth, this.borderHeight, 10);
    this.graphics.visible = false;
}
